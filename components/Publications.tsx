...
const conferences = [
  ...
  },
  {
    ...
    awardFile: "/cogsima2025_studentaward.pdf",
  },
  {
    title:
    ...
    nominationText: "Nominated for best paper award and best student paper awards",
  },
  {
                        ...
                        <div className="flex-shrink-0 flex gap-2 mt-1">
                          ...
                          {pub.nominationText && (
                            <div className="group relative">
                              ...
                              <div className="absolute right-0 bottom-full mb-2 px-3 py-2 bg-slate-900 text-white text-xs rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
                                {pub.nominationText}
                                <div className="absolute right-4 top-full w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-slate-900"></div>
                              </div>
                            </div>
                          )}
                        </div>
